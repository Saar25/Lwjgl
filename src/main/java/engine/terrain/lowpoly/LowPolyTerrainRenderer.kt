...
open class LowPolyTerrainRenderer @Throws(Exception::class) constructor() : Renderer3D<Terrain>() {
    ...
    companion object {
        private const val VERT_FILE = "/engine/terrain/lowpoly/lowPolyTerrainVert.glsl"
        private const val FRAG_FILE = "/engine/terrain/lowpoly/lowPolyTerrainFrag.glsl"

        @JvmStatic
        val instance = LowPolyTerrainRenderer()
    }
}
