...
public class Particles2 extends SimpleApplication {

    public static void main(String[] args) {
        try {
            SimpleApplication game = new Particles2();
    ...
    public void onInit(Window window, RenderManager renderer, Keyboard keyboard, Mouse mouse) throws Exception {
        ...
        final ParticleSystem particleSystem1 = new ParticleSystem(
                new CircleParticlePlacer(Vector3.of(0, 10, 0), 10), skin1);
        particleSystem1.setMaxPerUpdate(1);
        particleSystem1.setMaxParticles(5000);
        particleSystem1.getTransform().setPosition(-15, 0, 0);
        ...
        particleSystem3.getTransform().setPosition(15, 10, 0);
        particleSystem3.setMaxParticles(5000);
        ...
        final CameraLookAtRotation rotation = new CameraLookAtRotation(Vector3.zero());
